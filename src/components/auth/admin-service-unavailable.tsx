...
export function AdminServiceUnavailable() {
  ...
  return (
    <main className="admin-grid flex min-h-screen items-center justify-center bg-white px-6 py-16">
      <div className="w-full max-w-lg text-center">
        <Image
          ...
          priority
        />
        <span className="mx-auto mt-12 flex size-14 items-center justify-center rounded-full bg-amber-50 text-amber-700">
        ...
        <p className="mt-3 text-sm leading-6 text-zinc-500">
          일시적인 서버 문제일 수 있습니다. 잠시 후 다시 시도해 주세요.
          반복되면 관리자에게 문의해 주세요.
        </p>
